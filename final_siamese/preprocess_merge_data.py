'''This script prepares and merges the data:
Combines the Deloitte Drug Discovery dataset with additional features from the BindingDB dataset.
Ensures critical numerical features are present and ready for model training.
Performs any necessary cleaning and formatting of the merged dataset.
'''
...
def main():
    ...
    batch_dir = "bindingdb_batches"
    output_filepath = "merged_dataset.csv"
